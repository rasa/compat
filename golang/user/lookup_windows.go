...
import (
	...
	// "internal/syscall/windows/registry" // compat: s|"internal|// "internal|.
	"runtime"
	"syscall"
	"unsafe"

	"github.com/rasa/compat/golang/syscall/windows"          // compat: added
	"github.com/rasa/compat/golang/syscall/windows/registry" // compat: added
)
