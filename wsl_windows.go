...
// Windows. For example, executing whoami will run /usr/bin/whoami version, and
// executing whoami.exe will run C:/Windows/System32/whoami.exe. But it doesn't
...
// WSL see. Hence, this function must return false. Crazy, huh?
func IsWSL() bool {
	return false
}
